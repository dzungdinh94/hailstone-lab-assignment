...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'hailstone';
    ...
    'jhipster.mail.from' = 'hailstone@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'hailstone API';
    'jhipster.swagger.description' = 'hailstone API documentation';
    ...
    'eureka.instance.appname' = 'hailstone';
    'eureka.instance.instanceId' = 'hailstone:${random.value}';
